...
The [Fleet SysOps Manifesto](https://fleetsysops.com/manifesto.md), for the one human running a fleet of coding agents (fleet coding, if you want a name for it), and the documents that follow it, served as nothing but Markdown.
